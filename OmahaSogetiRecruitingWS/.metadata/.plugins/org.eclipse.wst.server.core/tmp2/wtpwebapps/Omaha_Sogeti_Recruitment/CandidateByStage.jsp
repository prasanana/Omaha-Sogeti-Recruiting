...
<title>Candidate By Stages</title>
...
<link href="${pageContext.request.contextPath}/stylesheets/CandidateByStage.css" rel="stylesheet"/>
</head>
<body onload = "candidateByStageOnLoad()">
<div id="wrapper">
...
<ul class="nav">
        ...
        <div id="page-wrapper" class="page-wrapper-cls">
            <div id="page-inner">
             ...
             <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Candidates by Stage </h1>
                    </div>
                </div>
<form name = "candidateByStageForm" action="CandidateByStage" method="get">
<div>
<label>Date: </label>
<input type = "date" id = "candidateByStageDate" name = "candidateByStageDate"/>
<input type = "submit" value = "Go" id = "candidateByStageDateGo"/>
</div>
 
<br>           
<div id="accordion-resizer" class="ui-widget-content">
<div id="candidateByStageAccordion">
<c:forEach var="stages" items="${stagesAndCandidates}">        
    <h3><c:out value="${stages.key}"/> : ${fn:length(stages.value)}</h3>
    <div>
      <c:forEach var="candidate" items="${stages.value}">
	<p><a href = "${pageContext.request.contextPath}/CandidateStageLifeSpan.jsp" target = "_blank">${candidate}</a></p>
	</c:forEach>
    </div>
 </c:forEach> 
</div>
...
<script src="${pageContext.request.contextPath}/javascript/CandidateByStage.js"></script>
</body>
</html>
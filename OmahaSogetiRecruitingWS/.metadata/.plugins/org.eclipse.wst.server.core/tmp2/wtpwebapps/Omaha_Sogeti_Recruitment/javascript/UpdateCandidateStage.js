/*********************************************************************************************************
 * Name: UpdateCandidateStage.js
 * Author: Prasanna Shankar
 * Date: 03/30/2015
 * Corresponding JSP: UpdateCandidateStage.jsp
 *********************************************************************************************************/

//called on load of UpdateCandidateStage.jsp
function fnOnload(){
	sortRows();
	searchRows();
}

//sort rows within the table based on <th>
function sortRows(){
...
//track all the candidates where comments are edited/added
...
//track all the candidates where stage is updated

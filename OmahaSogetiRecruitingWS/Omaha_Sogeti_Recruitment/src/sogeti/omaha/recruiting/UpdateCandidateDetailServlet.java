...
public class UpdateCandidateDetailServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.setAttribute("methodValue", methodValue);
		request.setAttribute("methodId", methodId);
		request.setAttribute("level", level);
		request.setAttribute("practiceValue", practiceValue);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		new sogeti.omaha.recruiting.UpdateCandidateDetailBean().updateCandidateDetails(request.getParameter("updateCandidateFirstName"), request.getParameter("updateCandidateLastName"), 
				request.getParameter("updateCandidateLinkedIn"), request.getParameter("updateCandidateEmail"), 
				request.getParameter("updateCandidateSKill"), request.getParameter("updateCandidateComments"), 
				request.getParameter("updateCandidateMethod"), request.getParameter("updateCandidateMethodReferal"), 
				request.getParameter("updateCandidateLevel"), request.getParameter("updateCandidatePractice"), request.getParameter("updateCandidatePhone"),
				request.getParameter("updateCandidateSalary"),
				request.getParameter("hiddenCandidateId").replace("/", ""));
		
		request.getRequestDispatcher("ModifyCandidateDetailsSuccess.jsp").forward(request, response);

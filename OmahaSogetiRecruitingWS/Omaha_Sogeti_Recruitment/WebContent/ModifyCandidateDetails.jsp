...
<link href="${pageContext.request.contextPath}/stylesheets/ModifyCandidateDetails.css" rel="stylesheet"/>
</head>
...
<ul class="nav">
        ...
        <div id="page-wrapper" class="page-wrapper-cls">
			...
			<div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Update Candidate Details </h1>
                    </div>
                </div>   
                <form name = "modifyCandidateDetailsForm" class="modifyCandidateDetailsForm" action="" method="post">
				<input type="text" id="modifyCandidateDetailsSearch" placeholder="Type to search for a candidate">
				<div class="modifyCandidateDetailsTableDiv">
				...
				<tbody>
				<c:forEach var="candidateDetails" items="${candidateDetails}">
				<tr class = "modifyCandidateDetailsData">
					<td><a href = "${pageContext.request.contextPath}/UpdateCandidateDetail?candidateID=${candidateDetails.key}" target = "_blank">${candidateDetails.value}</a></td>
      			</tr>
				</c:forEach>
				</tbody>
...
<script src="${pageContext.request.contextPath}/javascript/ModifyCandidateDetails.js"></script>
</body>
</html>
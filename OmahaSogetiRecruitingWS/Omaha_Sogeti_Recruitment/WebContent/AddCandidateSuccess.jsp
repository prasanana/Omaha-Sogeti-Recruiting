...
<title>Candidate Added Successfully</title>
...
<ul class="nav">
        ...
        <div id="page-wrapper" class="page-wrapper-cls">
			...
			<div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Candidate added successfully </h1>
                    </div>
                </div> 
                <a href = "${pageContext.request.contextPath}/AddCandidate">Back</a>             
            </div>
            <!-- /. PAGE INNER  -->
        </div>
        <!-- /. PAGE WRAPPER  -->
